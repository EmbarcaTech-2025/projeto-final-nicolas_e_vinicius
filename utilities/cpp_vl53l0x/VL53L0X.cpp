// From https://github.com/jrfo-hwit/hlab/tree/main/firmware/c_cpp/examples/5_vl53l0x_i2c_uart0
...
bool VL53L0X::init(bool io_2v8)
{
    ...
    // default: set final range signal rate limit to 0.25 MCPS (million counts per second)
    // setSignalRateLimit(0.25);
    setSignalRateLimit(0.1); // long-range : 0.25 for default
    ...
    #ifndef VL53L0X_LONG_RANGE
        measurement_timing_budget_us = getMeasurementTimingBudget(); //default
    #endif
    #ifdef VL53L0X_LONG_RANGE
        measurement_timing_budget_us = 33000; // long-range : 20000 for default
        setVcselPulsePeriod(VL53L0X::VcselPeriodPreRange, 18); // long-range : remove for default
        setVcselPulsePeriod(VL53L0X::VcselPeriodFinalRange, 14); // long-range : remove for default
    #endif
